...
public class LoginFrame extends JFrame {
    ...
    private void login() {
        ...
        try {
            ...
            ChatController controller = new ChatController("localhost", 5000);
            ...
            if (controller.login(username, password)) {
                ...
                JOptionPane.showMessageDialog(this, "Đăng nhập thất bại. Kiểm tra lại tài khoản/mật khẩu!", "Thất bại",
                        JOptionPane.ERROR_MESSAGE);
                controller.closeConnection();
            }
        } catch (IOException e) {
            JOptionPane.showMessageDialog(this, "Không thể kết nối hoặc xác thực với Server: " + e.getMessage(),
